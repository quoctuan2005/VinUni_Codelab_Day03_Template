...
class ChatbotBaseline:
    ...
    def query(self, user_input: str) -> str:
        ...
        return {
            "answer": "Bạn có thể tìm chuyến bay trên các trang web hàng không. Về thời tiết, bạn vui lòng tra cứu trên ứng dụng thời tiết.",
            "tool_calls": [],
            "status": "success"
        }
...
class ReActAgent:
    ...
    def plan_and_execute_step(self, user_input: str, iteration: int):
        """Phân tích Thought, chọn Action và ghi nhận Observation"""
    ...
    def run(self, user_input: str) -> dict:
        ...
        while iteration <= self.max_iterations:
            # TODO 3, 4, 5: Thực thi Thought - Action - Observation cho tới Final Answer
        ...
        # Milestone 4: Safeguard ngắt vòng lặp an toàn khi vượt max_iterations
        return {
